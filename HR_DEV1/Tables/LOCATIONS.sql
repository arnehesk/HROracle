CREATE TABLE hr_dev1.locations (
  ...
  CONSTRAINT loc_c_id_fk FOREIGN KEY (country_id) REFERENCES hr_dev1.countries (country_id)
);
...
COMMENT ON COLUMN hr_dev1.locations.postal_code IS 'Postal code of the location of an office, warehouse, or production site
of a company. ';
