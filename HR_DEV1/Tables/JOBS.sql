...
COMMENT ON COLUMN hr_dev1.jobs.min_salary IS 'Minimum salary for a job title.';
COMMENT ON COLUMN hr_dev1.jobs.max_salary IS 'Maximum salary for a job title.';